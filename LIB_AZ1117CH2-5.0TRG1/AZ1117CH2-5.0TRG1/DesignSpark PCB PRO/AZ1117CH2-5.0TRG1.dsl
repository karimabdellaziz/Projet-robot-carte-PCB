SamacSys ECAD Model
716593/644866/2.49/4/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AZ1117CH2-5_0TRG1" (originalName "AZ1117CH2-5_0TRG1")
		...
		(pin (pinNum 4) (pt 1600 mils 0 mils) (rotation 180) (pinLength 200 mils) (pinDisplay (dispPinName false)) (pinName (text (pt 1370 mils -25 mils) (rotation 0]) (justify "Right") (textStyleRef "Default"))
		))
	...
	(compDef "AZ1117CH2-5.0TRG1" (originalName "AZ1117CH2-5.0TRG1") (compHeader (numPins 4) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "INPUT") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "2" (pinName "ADJ/GND_1") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "3" (pinName "OUTPUT") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "ADJ/GND_2") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AZ1117CH2-5_0TRG1"))
		...
		(attr "Manufacturer_Part_Number" "AZ1117CH2-5.0TRG1")
		(attr "Mouser Part Number" "621-AZ1117CH2-5.0TRG")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AZ1117CH2-5.0TRG1?qs=5V6w%252Be2aIqb578qtLdqPjw%3D%3D")
		(attr "Arrow Part Number" "AZ1117CH2-5.0TRG1")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/az1117ch2-5.0trg1/diodes-incorporated")
		(attr "Mouser Testing Part Number" "")
		(attr "Mouser Testing Price/Stock" "")
		(attr "Description" "LDO Voltage Regulators LDO BJT HiCurr")
		(attr "Datasheet Link" "https://www.arrow.com/en/products/az1117ch2-5.0trg1/diodes-incorporated")
		(attr "Height" "1.8 mm")
	)
